...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Monitor.verticalHeader().setVisible(True)
        ...
        self.pushButton_imp.setGeometry(QtCore.QRect(10, 10, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_exp.setGeometry(QtCore.QRect(140, 10, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_new.setGeometry(QtCore.QRect(10, 70, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_drp = QtWidgets.QPushButton(self.editor)
        self.pushButton_drp.setGeometry(QtCore.QRect(140, 70, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_drp.setFont(font)
        self.pushButton_drp.setToolTipDuration(1)
        self.pushButton_drp.setObjectName("pushButton_drp")
        self.pushButton_add = QtWidgets.QPushButton(self.editor)
        self.pushButton_add.setGeometry(QtCore.QRect(10, 170, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_del.setGeometry(QtCore.QRect(140, 170, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_mod = QtWidgets.QPushButton(self.editor)
        self.pushButton_mod.setGeometry(QtCore.QRect(10, 230, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_mod.setFont(font)
        self.pushButton_mod.setToolTipDuration(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_imp.setText(_translate("MainWindow", "导入表格"))
        self.pushButton_exp.setText(_translate("MainWindow", "导出表格"))
        self.pushButton_new.setText(_translate("MainWindow", "新建表格"))
        self.pushButton_drp.setText(_translate("MainWindow", "删除表格"))
        self.pushButton_add.setText(_translate("MainWindow", "新增项"))
        self.pushButton_del.setText(_translate("MainWindow", "删除项"))
        self.pushButton_mod.setText(_translate("MainWindow", "修订项"))
